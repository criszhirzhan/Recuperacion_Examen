...
public class IngresarAutor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Autor autor1 = new Autor( "Pablo Neruda", "Mexicana");
		Autor autor2 = new Autor( "Mario Vargas llosa", "Española");
		Autor autor3 = new Autor( "Dan Bround", "Española");
		...
		System.out.println("Autores Ingresados");
